package com.api.rest.mongo.repaso.controllers;
...
public class ContactoControllerTests {
    ...
    public void testGuardarContacto(){
        Flux<Contacto> contactoFlux= webTestClient.post()
            ...
            .body(BodyInserters.fromValue(new Contacto("webtest", "w@gmail.com", "65468433")))
            .exchange()
            .expectStatus().isAccepted().returnResult(Contacto.class).getResponseBody().log();
